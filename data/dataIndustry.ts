...
export const dataIndustry: IndustryType[]  = [
    {
        srcImage: '/assets/Lunar-new-year.png',
        title: 'Happy Lunar New Year 2023 - A short announcement',
        description:'Best wishes and a short announcement for the Lunar New Year 2023 to all valued customers and partners!',
        date: '17 Jan 2023',
        iconCategory: 'assets/icons/announcements.svg',
        nameCategory:'Announcements'
    },
    {
        srcImage: '/assets/rcep-eu-vn.png',
        ...
        date: '3 Jun 2021',
        iconCategory: 'assets/icons/articles.svg',
        nameCategory:'Articles'
    },
    {
        srcImage: '/assets/EU__Vietnam.png',
    ...
    {
        srcImage: '/assets/investor-visa.png',
