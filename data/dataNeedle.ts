...
export const dataNeedle: NeedleType[] = [
    ...
    {
        srcImage: '/assets/section_2_2-vn-partner.png',
        title: 'Supporting marketing materials',
        description: `Take advantage of our Vietnam related resources and service brochures to outreach new clients. Make them feel more confident to enlist your services.`
    },
]